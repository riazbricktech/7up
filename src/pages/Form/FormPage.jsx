      ...
      dispatch(createUser(data)).then((res) => {
        ...
        if (res?.payload?.response?.return_value === 0) {
          if (
            ...
            "You have entered incorrect unique ID"
          ) {
            setIsCodeFound(true);
            return;
          } else if (
            res?.payload?.response?.return_message ===
            "YOUR UNIQUE ID HAS ALREADY BEEN USED"
          ) {
            ...
            <div className="tc_wrapper class-8">
              ...
              <div>
                ...
                <label
                  ...
                  htmlFor=""
                >
                  I consent to receiving product information and promotional
                  offers from PepsiCo, electronically, including, SMS & WhatsApp
                </label>
              </div>
            </div>
          </div>
